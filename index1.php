...
$sql = "SELECT * FROM EFICIENCIA_POR_DIA WHERE AREA IN ('ACONDICIONAMIENTO', 'ENSAMBLE', 'SELLADO', 'ENVASADO','EMPAQUE','LOTEO','DEVANADO')
                                    ...
                                    <tr>
                                     ...
                                     <!--   <td>
                                            <button class="abrir-pestaña"
                                                 data-url="detalle1.php?id=<?php echo htmlspecialchars($row['CODIGO_OPERARIO']); ?>">
                                                +
                                            </button>
                                        </td>---->
                                        <td>
